          ...
          <div className="stack">
            ...
            {dealerDetail && (
              <div className="panel">
                ...
                <div className="chart"><ResponsiveContainer width="100%" height="100%"><LineChart data={dealerDetail.last12Monthly}><CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="month" /><YAxis yAxisId="left" tickFormatter={(value: number) => euro0(value)} /><YAxis yAxisId="right" orientation="right" allowDecimals={false} tickFormatter={(value: number) => num(value)} /><Tooltip formatter={(value: number, key: string) => key === 'pratiche' ? num(value) : euro(value)} /><Legend /><Line type="monotone" dataKey="erogato" name="Erogato" yAxisId="left" stroke="#0ea5e9" strokeWidth={3} /><Line type="monotone" dataKey="pratiche" name="Pratiche" yAxisId="right" stroke="#22c55e" strokeWidth={2} /></LineChart></ResponsiveContainer></div>
