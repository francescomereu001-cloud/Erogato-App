...
export function buildDealerReportHtml(data: DealerReportData) {
  ...
  <div class="grid"><div class="card"><div class="label">Erogato YTD</div><div class="value">${euro0(ytdErogatoCurrent)}</div></div><div class="card"><div class="label">Erogato anno precedente</div><div class="value">${euro0(ytdErogatoPrev)}</div></div><div class="card"><div class="label">Pratiche YTD</div><div class="value">${num(ytdPraticheCurrent)}</div></div><div class="card"><div class="label">Ticket medio YTD</div><div class="value">${euro0(ytdTicketCurrent)}</div></div><div class="card"><div class="label">Rate medie YTD</div><div class="value">${fmtRates(ytdRatesCurrent)}</div><div class="sub">${coverage === null ? 'Numero rate non disponibile' : `Disponibile sul ${fmtPct(coverage)} delle pratiche YTD`}</div></div><div class="card"><div class="label">Polizze YTD</div><div class="value">${num(ytdPolizzeCurrent)}</div></div></div>
